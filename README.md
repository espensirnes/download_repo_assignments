...
Before you give out the assignment, you need to make sure that everybody calls the repository the same (or at least with not too many variations), so be very specific on what they should call the repository!
